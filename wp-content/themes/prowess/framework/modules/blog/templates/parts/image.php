...
$blog_list_image_id  = ! empty( $image_meta ) && prowess_select_blog_item_has_link() ? prowess_select_get_attachment_id_from_url( $image_meta ) : '';
?>

<?php if ( $has_featured ) { ?>
	<div class="qodef-post-image">
		<?php if ( prowess_select_blog_item_has_link() ) { ?>
		...
		<?php } ?>
		<?php do_action('prowess_select_action_blog_inside_image_tag')?>
	</div>
<?php } ?>