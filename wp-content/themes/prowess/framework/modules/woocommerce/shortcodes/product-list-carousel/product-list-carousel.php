...
namespace ProwessCore\CPT\Shortcodes\ProductListCarousel;
...
class ProductListCarousel implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'                      => esc_html__( 'Product List - Carousel', 'prowess' ),
					'base'                      => $this->base,
					...
					'params'                    => array(
						array(
							...
							'value'       => array(
								...
								esc_html__( 'Simple', 'prowess' )   => 'simple'
							),
							'save_always' => true
						),
						array(
						...
						array(
							...
							'heading'     => esc_html__( 'Number Of Visible Items', 'prowess' ),
							'value'       => array(
							...
							'save_always' => true,
							'group'       => esc_html__( 'Slider Settings', 'prowess' )
						),
						array(
							'type'        => 'dropdown',
							'param_name'  => 'slider_loop',
							'heading'     => esc_html__( 'Enable Slider Loop', 'prowess' ),
						...
						array(
							...
							'heading'     => esc_html__( 'Enable Slider Autoplay', 'prowess' ),
							'value'       => array_flip( prowess_select_get_yes_no_select_array( false, true ) ),
							'save_always' => true,
							'group'       => esc_html__( 'Slider Settings', 'prowess' )
						),
						array(
							...
							'heading'     => esc_html__( 'Slide Duration', 'prowess' ),
							'description' => esc_html__( 'Default value is 5000 (ms)', 'prowess' ),
							'group'       => esc_html__( 'Slider Settings', 'prowess' )
						),
						array(
							'type'        => 'textfield',
							'param_name'  => 'slider_speed_animation',
							'heading'     => esc_html__( 'Slide Animation Duration', 'prowess' ),
							'description' => esc_html__( 'Speed of slide animation in milliseconds. Default value is 600.', 'prowess' ),
							'group'       => esc_html__( 'Slider Settings', 'prowess' )
						),
						array(
							'type'        => 'dropdown',
							'param_name'  => 'slider_navigation',
							'heading'     => esc_html__( 'Enable Slider Navigation Arrows', 'prowess' ),
							'value'       => array_flip( prowess_select_get_yes_no_select_array( false, true ) ),
							'save_always' => true,
							'group'       => esc_html__( 'Slider Settings', 'prowess' )
						),
						array(
							...
							'heading'    => esc_html__( 'Slider Navigation Skin', 'prowess' ),
							'value'      => array(
						...
						array(
							...
							'heading'     => esc_html__( 'Enable Slider Pagination', 'prowess' ),
							'value'       => array_flip( prowess_select_get_yes_no_select_array( false, true ) ),
							'save_always' => true,
							'group'       => esc_html__( 'Slider Settings', 'prowess' )
						),
						array(
							...
							'heading'    => esc_html__( 'Slider Pagination Skin', 'prowess' ),
							'value'      => array(
								esc_html__( 'Default', 'prowess' ) => 'default',
								esc_html__( 'Light', 'prowess' )   => 'light'
							),
						...
						array(
							...
							'heading'    => esc_html__( 'Slider Pagination Position', 'prowess' ),
							'value'      => array(
								esc_html__( 'Below Carousel', 'prowess' )  => 'bellow-slider',
								esc_html__( 'Inside Carousel', 'prowess' ) => 'inside-slider'
							),
							'dependency' => array( 'element' => 'slider_pagination', 'value' => array( 'yes' ) ),
							'group'      => esc_html__( 'Slider Settings', 'prowess' )
						),
	...
	public function render( $atts, $content = null ) {
		...
		$html = prowess_select_get_woo_shortcode_module_template_part( 'templates/product-list', 'product-list-carousel', $params['type'], $params, $additional_params );
