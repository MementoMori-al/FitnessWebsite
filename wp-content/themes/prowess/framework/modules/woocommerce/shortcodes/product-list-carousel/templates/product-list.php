...
<div class="qodef-plc-holder <?php echo esc_attr( $holder_classes ) ?>">
	<div class="qodef-plc-outer qodef-owl-slider" <?php echo prowess_select_get_inline_attrs( $holder_data ); ?>>
		<?php if ( $query_result->have_posts() ): while ( $query_result->have_posts() ) : $query_result->the_post(); ?>
			<div class="qodef-plc-item">
				<div class="qodef-plc-image-outer">
					...
					<div class="qodef-plc-text" <?php echo prowess_select_get_inline_style( $shader_styles ); ?>>
