...
if ( ! function_exists('prowess_select_breadcrumbs_title_type_options_map') ) {
	function prowess_select_breadcrumbs_title_type_options_map($panel_typography) {
		
		prowess_select_add_admin_section_title(
			array(
				'name'   => 'type_section_breadcrumbs',
				'title'  => esc_html__( 'Breadcrumbs', 'prowess' ),
				'parent' => $panel_typography
			)
		);
	
		$group_page_breadcrumbs_styles = prowess_select_add_admin_group(
			array(
				'name'        => 'group_page_breadcrumbs_styles',
				'title'       => esc_html__( 'Breadcrumbs', 'prowess' ),
				'description' => esc_html__( 'Define styles for page breadcrumbs', 'prowess' ),
				'parent'      => $panel_typography
			)
		);
	
			$row_page_breadcrumbs_styles_1 = prowess_select_add_admin_row(
				array(
			...
			$row_page_breadcrumbs_styles_2 = prowess_select_add_admin_row(
				array(
			...
			$row_page_breadcrumbs_styles_3 = prowess_select_add_admin_row(
				array(
	...
	add_action( 'prowess_select_additional_title_typography_options_map', 'prowess_select_breadcrumbs_title_type_options_map');
}