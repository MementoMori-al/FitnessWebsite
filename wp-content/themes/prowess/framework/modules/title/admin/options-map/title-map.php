...
if ( ! function_exists( 'prowess_select_get_title_types_options' ) ) {
	function prowess_select_get_title_types_options() {
		$title_type_options = apply_filters( 'prowess_select_title_type_global_option', $title_type_options = array() );
		
		return $title_type_options;
	}
}

if ( ! function_exists( 'prowess_select_get_title_type_default_options' ) ) {
	function prowess_select_get_title_type_default_options() {
		$title_type_option = apply_filters( 'prowess_select_default_title_type_global_option', $title_type_option = '' );
...
if ( ! function_exists('prowess_select_title_options_map') ) {
	function prowess_select_title_options_map() {
		$title_type_options        = prowess_select_get_title_types_options();
		$title_type_default_option = prowess_select_get_title_type_default_options();
		...
		$panel_title = prowess_select_add_admin_panel(
			array(
				'page' => '_title_page',
				'name' => 'panel_title',
				'title' => esc_html__('Title Settings', 'prowess')
			)
		);
		...
		prowess_select_add_admin_field(
			array(
				...
				'description'   => esc_html__( 'This option will enable/disable Title Area', 'prowess' ),
				'parent'        => $panel_title
			)
		);
		
			$show_title_area_container = prowess_select_add_admin_container(
				array(
					'parent'          => $panel_title,
				...
				prowess_select_add_admin_field(
					...
					prowess_select_add_admin_field(
						array(
							...
							'description'   => esc_html__( 'Specify title vertical alignment', 'prowess' ),
							'parent'        => $show_title_area_container,
							'options'       => array(
		...
		do_action( 'prowess_select_additional_title_area_options_map', $show_title_area_container );
		
		/***************** Additional Title Area Layout - end *****************/
		
		
		$panel_typography = prowess_select_add_admin_panel(
			array(
				'page'  => '_title_page',
			...
			$group_page_title_styles = prowess_select_add_admin_group(
				array(
					'name'        => 'group_page_title_styles',
					'title'       => esc_html__( 'Title', 'prowess' ),
					'description' => esc_html__( 'Define styles for page title', 'prowess' ),
					'parent'      => $panel_typography
				)
			);
		
				$row_page_title_styles_1 = prowess_select_add_admin_row(
					array(
				...
				$row_page_title_styles_2 = prowess_select_add_admin_row(
					array(
				...
				$row_page_title_styles_3 = prowess_select_add_admin_row(
					array(
			...
			prowess_select_add_admin_section_title(
				array(
					...
					'title'  => esc_html__( 'Subtitle', 'prowess' ),
					'parent' => $panel_typography
				)
			);
		
			$group_page_subtitle_styles = prowess_select_add_admin_group(
				array(
					'name'        => 'group_page_subtitle_styles',
					'title'       => esc_html__( 'Subtitle', 'prowess' ),
					'description' => esc_html__( 'Define styles for page subtitle', 'prowess' ),
					'parent'      => $panel_typography
				)
			);
		
				$row_page_subtitle_styles_1 = prowess_select_add_admin_row(
					array(
				...
				$row_page_subtitle_styles_2 = prowess_select_add_admin_row(
					array(
				...
				$row_page_subtitle_styles_3 = prowess_select_add_admin_row(
					array(
		...
		do_action( 'prowess_select_additional_title_typography_options_map', $panel_typography );
		
		/***************** Additional Title Typography Layout - end *****************/
    }

	add_action( 'prowess_select_options_map', 'prowess_select_title_options_map', 6);
}