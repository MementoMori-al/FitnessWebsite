...
if ( ! function_exists('prowess_select_contact_form_7_options_map') ) {

	function prowess_select_contact_form_7_options_map() {
		
		prowess_select_add_admin_page(
			array(
				'slug'  => '_contact_form7_page',
				'title' => esc_html__( 'Contact Form 7', 'prowess' ),
				'icon'  => 'fa fa-envelope-o'
			)
		);
		
		$panel_contact_form_style_1 = prowess_select_add_admin_panel(
			array(
				'page'  => '_contact_form7_page',
				'name'  => 'panel_contact_form_style_1',
				'title' => esc_html__( 'Custom Style 1', 'prowess' )
			)
		);
		
		//Text Typography
		
		$typography_text_group = prowess_select_add_admin_group(
			array(
				'name'        => 'typography_text_group',
				'title'       => esc_html__( 'Form Text Typography', 'prowess' ),
				'description' => esc_html__( 'Setup typography for form elements text', 'prowess' ),
				'parent'      => $panel_contact_form_style_1
			)
		);
		
		$typography_text_row1 = prowess_select_add_admin_row(
			array(
		...
		prowess_select_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Focus Text Color', 'prowess' ),
			)
		);
		...
		$typography_text_row2 = prowess_select_add_admin_row(
			array(
		...
		$typography_text_row3 = prowess_select_add_admin_row(
			array(
		...
		$typography_label_group = prowess_select_add_admin_group(
			array(
				'name'        => 'typography_label_group',
				'title'       => esc_html__( 'Form Label Typography', 'prowess' ),
				'description' => esc_html__( 'Setup typography for form elements label', 'prowess' ),
				'parent'      => $panel_contact_form_style_1
			)
		);
		
		$typography_label_row1 = prowess_select_add_admin_row(
			array(
		...
		$typography_label_row2 = prowess_select_add_admin_row(
			array(
		...
		$background_border_group = prowess_select_add_admin_group(
			array(
				'name'        => 'background_border_group',
				'title'       => esc_html__( 'Form Elements Background and Border', 'prowess' ),
				'description' => esc_html__( 'Setup form elements background and border style', 'prowess' ),
				'parent'      => $panel_contact_form_style_1
			)
		);
		
		$background_border_row1 = prowess_select_add_admin_row(
			array(
		...
		prowess_select_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Focus Background Color', 'prowess' )
			)
		);
		...
		prowess_select_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Focus Background Transparency', 'prowess' )
			)
		);
		
		$background_border_row2 = prowess_select_add_admin_row(
			array(
		...
		prowess_select_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Border Transparency', 'prowess' ),
			)
		);
		...
		prowess_select_add_admin_field(
			array(
				...
				'label'  => esc_html__( 'Focus Border Color', 'prowess' )
			)
		);
		...
		prowess_select_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Focus Border Transparency', 'prowess' )
			)
		);
		
		$background_border_row3 = prowess_select_add_admin_row(
			array(
		...
		prowess_select_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Border Width', 'prowess' ),
				'args'          => array(
					'suffix' => 'px'
				)
			)
		...
		prowess_select_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Border Radius', 'prowess' ),
				'args'          => array(
					'suffix' => 'px'
				)
			)
		...
		$padding_group = prowess_select_add_admin_group(
			array(
				'name'        => 'padding_group',
				'title'       => esc_html__( 'Elements Padding', 'prowess' ),
				'description' => 'Setup form elements padding',
				'parent'      => $panel_contact_form_style_1
			)
		);
		
		$padding_row = prowess_select_add_admin_row(
			array(
				'name'   => 'padding_row',
		...
		prowess_select_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Padding Top', 'prowess' ),
				'args'          => array(
					'suffix' => 'px'
				)
			)
		...
		prowess_select_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Padding Right', 'prowess' ),
				'args'          => array(
					'suffix' => 'px'
				)
			)
		...
		prowess_select_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Padding Bottom', 'prowess' ),
				'args'          => array(
					'suffix' => 'px'
				)
			)
		...
		prowess_select_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Padding Left', 'prowess' ),
				'args'          => array(
					'suffix' => 'px'
				)
			)
		...
		$margin_group = prowess_select_add_admin_group(
			array(
				'name'        => 'margin_group',
				'title'       => esc_html__( 'Elements Margin', 'prowess' ),
				'description' => esc_html__( 'Setup form elements margin', 'prowess' ),
				'parent'      => $panel_contact_form_style_1
			)
		);
		
		$margin_row = prowess_select_add_admin_row(
			array(
				'name'   => 'margin_row',
				'parent' => $margin_group
			)
		...
		prowess_select_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Textarea Height', 'prowess' ),
				'description'   => esc_html__( 'Enter height for textarea form element', 'prowess' ),
				'args'          => array(
					'col_width' => '3',
					'suffix'    => 'px'
				)
		...
		$button_typography_group = prowess_select_add_admin_group(
			array(
				'name'        => 'button_typography_group',
				'title'       => esc_html__( 'Button Typography', 'prowess' ),
				'description' => esc_html__( 'Setup button text typography', 'prowess' ),
				'parent'      => $panel_contact_form_style_1
			)
		);
		
		$button_typography_row1 = prowess_select_add_admin_row(
			array(
		...
		$button_typography_row2 = prowess_select_add_admin_row(
			array(
		...
		$button_background_border_group = prowess_select_add_admin_group(
			array(
				'name'        => 'button_background_border_group',
				'title'       => esc_html__( 'Button Background and Border', 'prowess' ),
				'description' => esc_html__( 'Setup button background and border style', 'prowess' ),
				'parent'      => $panel_contact_form_style_1
			)
		);
		
		$button_background_border_row1 = prowess_select_add_admin_row(
			array(
		...
		prowess_select_add_admin_field(
			array(
				...
				'label'  => esc_html__( 'Background Hover Color', 'prowess' )
			)
		);
		...
		prowess_select_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Background Hover Transparency', 'prowess' )
			)
		);
		
		$button_background_border_row2 = prowess_select_add_admin_row(
			array(
		...
		prowess_select_add_admin_field(
			array(
				...
				'label'  => esc_html__( 'Border Hover Color', 'prowess' )
			)
		);
		...
		prowess_select_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Border Hover Transparency', 'prowess' )
			)
		);
		
		$button_background_border_row3 = prowess_select_add_admin_row(
			array(
		...
		prowess_select_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Button Height', 'prowess' ),
				'args'          => array(
					'col_width' => '3',
					'suffix'    => 'px'
				)
		...
		prowess_select_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Button Left/Right Padding', 'prowess' ),
				'args'          => array(
					'col_width' => '3',
					'suffix'    => 'px'
				)
		...
		$panel_contact_form_style_2 = prowess_select_add_admin_panel(array(
			'page'	=> '_contact_form7_page',
			'name'	=> 'panel_contact_form_style_2',
			'title'	=> esc_html__('Custom Style 2', 'prowess')
		));

		//Text Typography

		$typography_text_group = prowess_select_add_admin_group(array(
			'name'			=> 'typography_text_group',
			'title'			=> esc_html__('Form Text Typography', 'prowess'),
			'description'	=> esc_html__('Setup typography for form elements text', 'prowess'),
		...
		$typography_text_row1 = prowess_select_add_admin_row(array(
			'name'		=> 'typography_text_row1',
			'parent'	=> $typography_text_group
		));
		...
		$typography_text_row2 = prowess_select_add_admin_row(array(
			'name'		=> 'typography_text_row2',
			'next'		=> true,
			'parent'	=> $typography_text_group
		));
		...
		$typography_text_row3 = prowess_select_add_admin_row(array(
			'name'		=> 'typography_text_row3',
			'next'		=> true,
			'parent'	=> $typography_text_group
		));
		...
		$typography_label_group = prowess_select_add_admin_group(array(
			'name'			=> 'typography_label_group',
			'title'			=> esc_html__('Form Label Typography', 'prowess'),
			'description'	=> esc_html__('Setup typography for form elements label', 'prowess'),
			'parent'		=> $panel_contact_form_style_2
		...
		$typography_label_row1 = prowess_select_add_admin_row(array(
			'name'		=> 'typography_label_row1',
			'parent'	=> $typography_label_group
		));
		...
		$typography_label_row2 = prowess_select_add_admin_row(array(
			'name'		=> 'typography_label_row2',
			'next'		=> true,
			'parent'	=> $typography_label_group
		));
		...
		$background_border_group = prowess_select_add_admin_group(array(
			'name'			=> 'background_border_group',
			'title'			=> esc_html__('Form Elements Background and Border', 'prowess'),
			'description'	=> esc_html__('Setup form elements background and border style', 'prowess'),
			'parent'		=> $panel_contact_form_style_2
		...
		$background_border_row1 = prowess_select_add_admin_row(array(
			'name'		=> 'background_border_row1',
			'parent'	=> $background_border_group
		));
		...
		$background_border_row2 = prowess_select_add_admin_row(array(
			'name'		=> 'background_border_row2',
			'next'		=> true,
			'parent'	=> $background_border_group
		));
		...
		$background_border_row3 = prowess_select_add_admin_row(array(
			'name'		=> 'background_border_row3',
			'next'		=> true,
			'parent'	=> $background_border_group
		));
		...
		$padding_group = prowess_select_add_admin_group(array(
			'name'			=> 'padding_group',
			'title'			=> esc_html__('Elements Padding', 'prowess'),
			'description'	=> 'Setup form elements padding',
			'parent'		=> $panel_contact_form_style_2
		...
		$padding_row = prowess_select_add_admin_row(array(
			'name'		=> 'padding_row',
			'parent'	=> $padding_group
		));
		...
		$margin_group = prowess_select_add_admin_group(array(
			'name'			=> 'margin_group',
			'title'			=> esc_html__('Elements Margin', 'prowess'),
			'description'	=> esc_html__('Setup form elements margin', 'prowess'),
			'parent'		=> $panel_contact_form_style_2
		...
		$margin_row = prowess_select_add_admin_row(array(
			'name'		=> 'margin_row',
			'parent'	=> $margin_group
		));
		...
		$button_typography_group = prowess_select_add_admin_group(array(
			'name'			=> 'button_typography_group',
			'title'			=> esc_html__('Button Typography', 'prowess'),
			'description'	=> esc_html__('Setup button text typography', 'prowess'),
			'parent'		=> $panel_contact_form_style_2
		...
		$button_typography_row1 = prowess_select_add_admin_row(array(
			'name'		=> 'button_typography_row1',
			'parent'	=> $button_typography_group
		));
		...
		$button_typography_row2 = prowess_select_add_admin_row(array(
			'name'		=> 'button_typography_row2',
			'next'		=> true,
			'parent'	=> $button_typography_group
		));
		...
		$button_background_border_group = prowess_select_add_admin_group(array(
			'name'			=> 'button_background_border_group',
			'title'			=> esc_html__('Button Background and Border', 'prowess'),
			'description'	=> esc_html__('Setup button background and border style', 'prowess'),
			'parent'		=> $panel_contact_form_style_2
		...
		$button_background_border_row1 = prowess_select_add_admin_row(array(
			'name'		=> 'button_background_border_row1',
			'parent'	=> $button_background_border_group
		));
		...
		$button_background_border_row2 = prowess_select_add_admin_row(array(
			'name'		=> 'button_background_border_row2',
			'next'		=> true,
			'parent'	=> $button_background_border_group
		));
		...
		$button_background_border_row3 = prowess_select_add_admin_row(array(
			'name'		=> 'button_background_border_row3',
			'next'		=> true,
			'parent'	=> $button_background_border_group
		));
        ...
        $panel_contact_form_style_3 = prowess_select_add_admin_panel(array(
            'page'	=> '_contact_form7_page',
            'name'	=> 'panel_contact_form_style_3',
            'title'	=> esc_html__('Custom Style 3', 'prowess')
        ));
        ...
        $typography_label_row3 = prowess_select_add_admin_row(array(
        ...
        $button_typography_row3 = prowess_select_add_admin_row(array(
	...
	add_action( 'prowess_select_options_map', 'prowess_select_contact_form_7_options_map', 20);
}