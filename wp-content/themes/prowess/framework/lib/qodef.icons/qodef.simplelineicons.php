...
class ProwessSimpleLineIcons implements iProwessIconCollection {
    ...
    public function setSocialIconsArray() {
        $this->socialIcons = array(
            ''                        => '',
            'icon-social-behance'     => esc_html__('Behance', 'prowess'),
            'icon-social-dribbble'    => esc_html__('Dribbble', 'prowess'),
            'icon-social-dropbox'     => esc_html__('Dropbox', 'prowess'),
            'icon-social-facebook'    => esc_html__('Facebook', 'prowess'),
            'icon-social-foursquare'  => esc_html__('Foursquare', 'prowess'),
            'icon-social-github'      => esc_html__('Github', 'prowess'),
            'icon-social-gplus'       => esc_html__('Google Plus', 'prowess'),
            'icon-social-instagram'   => esc_html__('Instagram', 'prowess'),
            'icon-social-linkedin'    => esc_html__('LinkedIn', 'prowess'),
            'icon-social-pintarest'   => esc_html__('Pinterest', 'prowess'),
            'icon-social-reddit'      => esc_html__('Reddit', 'prowess'),
            'icon-social-skype'       => esc_html__('Skype', 'prowess'),
            'icon-social-soundcloud'  => esc_html__('Soundcloud', 'prowess'),
            'icon-social-stumbleupon' => esc_html__('Stumbleupon', 'prowess'),
            'icon-social-spotify'     => esc_html__('Spotify', 'prowess'),
            'icon-social-tumblr'      => esc_html__('Tumblr', 'prowess'),
            'icon-social-twitter'     => esc_html__('Twitter', 'prowess'),
            'icon-social-youtube'     => esc_html__('Youtube', 'prowess')
        );
    }
