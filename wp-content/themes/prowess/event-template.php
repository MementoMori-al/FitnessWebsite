...
<div class="qodef-container qodef-default-page-template">
	<?php do_action('prowess_select_action_after_container_open'); ?>
	<div class="qodef-container-inner clearfix">
		<?php if (have_posts()) : while (have_posts()) : the_post(); ?>
			<div class="qodef-grid-row">
				<div <?php echo prowess_select_get_content_sidebar_class(); ?>>
					<?php
					prowess_select_get_tt_event_single_content();
					do_action('prowess_select_action_page_after_content');
					?>
				</div>
	...
	<?php do_action('prowess_select_action_before_container_close'); ?>
</div>
<?php get_footer(); ?>
