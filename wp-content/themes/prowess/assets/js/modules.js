...
(function($) {
	...
	common.qodefParallaxItems = qodefParallaxItems;
                ...
                searchField.on('keyup paste', function() {
                    ...
                    keyPressTimeout = setTimeout( function() {
                        ...
                        if(searchTerm.length < 3) {
                            ...
                            var ajaxData = {
                                action: 'prowess_select_search_post_types',
                                term: searchTerm,
                                postType: postType,
	...
	function qodefInitBlogPagination(){
		...
		var initMainPagFunctionality = function(thisHolder) {
            ...
            if(nextPage <= maxNumPages){
				...
				var ajaxData = qodef.modules.common.setLoadMoreAjaxData(loadMoreDatta, 'prowess_select_blog_load_more');
    ...
    function qodefInitBlogListShortcodePagination(){
        ...
        var initMainPagFunctionality = function(thisHolder, pagedLink) {
            ...
            if(nextPage <= maxNumPages){
                ...
                var ajaxData = qodef.modules.common.setLoadMoreAjaxData(loadMoreDatta, 'prowess_select_blog_shortcode_load_more');
				...
				thisItem.on('tap click', function (e) {
					...
					if (thisItemParent.hasClass('has_sub')) {
						...
						if (submenu.is(':visible')) {
							...
							if (thisItemParentSiblingsWithDrop.length === 0) {
								thisItemParent.removeClass('qodef-opened').find('.sub_menu').slideUp(400, 'easeInOutQuint', function () {
									submenu.slideDown(400, 'easeInOutQuint');
								});
							} else {
	...
	*/
	...
	function qodefResizePortfolioMasonryLayoutItems(size,container){
		if(container.find('.qodef-ps-fixed-masonry').length) {
			var space_between_items = parseInt(container.find('.qodef-ps-image').css('paddingLeft'), 10),
				newSize = size - 2 * space_between_items,
...
(function($) {
    ...
    function qodefInitLoadMoreItemsPortfolioFilter($portfolioList, $filterValue, $filterClassName) {
        ...
        var	loadMoreDatta = qodef.modules.common.getLoadMoreData(thisPortList),
            nextPage = loadMoreDatta.nextPage,
	        ajaxData = qodef.modules.common.setLoadMoreAjaxData(loadMoreDatta, 'prowess_core_portfolio_ajax_load_more'),
	...
	function qodefInitPortfolioPagination(){
		...
		var initMainPagFunctionality = function(thisPortList, pagedLink) {
			...
			if(nextPage <= maxNumPages || maxNumPages === 0){
				...
				var ajaxData = qodef.modules.common.setLoadMoreAjaxData(loadMoreDatta, 'prowess_core_portfolio_ajax_load_more');
