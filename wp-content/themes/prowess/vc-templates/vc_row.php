...
if (!empty($enable_grid_lines)){
	$css_classes[] = 'qodef-' . esc_attr($enable_grid_lines);
}
...
if($row_content_width === 'grid'){
	$qodef_row_wrapper_start .= '<div class="qodef-row-grid-section-wrapper '.esc_attr($grid_row_classes).'" '.esc_attr($grid_row_datas).' ' . prowess_select_get_inline_style( $qodef_grid_row_styles ) . '><div class="qodef-row-grid-section">';
	$qodef_row_wrapper_end .= '</div></div>';
}

$qodef_grid_row_parallax_grids = '';
if( $enable_grid_lines === 'grid_line_right' ) {
	$qodef_grid_row_parallax_grids = '<span class="qodef-grid-line-right"><span class="qodef-grid-line-inner" data-parallax="{&quot;y&quot;:-450, &quot;smoothness&quot;:25}"></span></span>';
} 

else if( $enable_grid_lines === 'grid_line_dual' ) {
	$qodef_grid_row_parallax_grids = '<span class="qodef-grid-line-center"><span class="qodef-grid-line-inner" data-parallax="{&quot;y&quot;:750, &quot;smoothness&quot;:25}"></span></span><span class="qodef-grid-line-right"><span class="qodef-grid-line-inner" data-parallax="{&quot;y&quot;:-450, &quot;smoothness&quot;:25}"></span></span>';
}
...
$output .= '<div ' . implode( ' ', $wrapper_attributes ) . ' ' . prowess_select_get_inline_style( $qodef_vc_row_styles ) . '>';
$output .= wpb_js_remove_wpautop( $content );
$output .= $qodef_grid_row_parallax_grids;
$output .= '</div>';
$output .= $qodef_row_wrapper_end;
$output .= $after_output;

print prowess_select_get_module_part($output);
